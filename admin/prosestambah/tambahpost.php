...
<head>
  ...
  <title>AdminLTE 3 | Buat Artikel | <?php echo $nama;?></title>
...
function Submit(){
    ...
    $tanggal_post    =  e($_POST['tanggal_post']);
    $penulis    =  e($_POST['penulis']);
    $judul    =  e($_POST['judul']);
   ...
   if(empty($tanggal_post) || empty($penulis) || empty($judul) || empty($idkategori) || empty($isi) || empty($meta_key) || empty($meta_des) || empty($userfile)) {
  ...
  window.location = "";
    ...
    if (count($errors) == 0) {
        ...
        if (isset($_POST['judul'])) {
            $judul = e($_POST['judul']);
            $query = "INSERT INTO post (judul, idkategori, isi, userfile, tanggal_post, penulis, meta_key, meta_des) 
                      VALUES('$judul', '$idkategori', '$isi', '$userfile', '$tanggal_post', '$penulis', '$meta_key', '$meta_des')";
            mysqli_query($conn, $query);            
    echo '<script>
    swal({
     title: "Good job!",
     text: "blog Berhasil DI Tambah",
     icon: "success",
     button: "oke!",
   }).then(function() {
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="tab-content">
                  ...
                  <form action="tambahpost" method="POST" enctype='multipart/form-data'  class="form-horizontal">
                      
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Tgl Buat</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control"  name="tanggal_post" readonly value="<?php
...
?> " >
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control"  name="penulis" readonly value="<?php echo $nama_user; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
...
?>
                      ...
                      <div class="form-group row">
                        <label for="inputExperience" class="col-sm-2 col-form-label">Isi Artikel</label>
                        <div class="col-sm-10">
