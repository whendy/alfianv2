...
$pdf->Image('../foto/images.png',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'KIOS Pandanux',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 0038XXXXXXX',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. Kp Boelak',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'website : dwiki.id email : dwikiye@dwiki.id',0,'L');
...
$tanggal=$_GET['tanggal'];
	$query = mysqli_query($mysqli, "select * from barang_laku where tanggal=" . $tanggal);
	...
	$q = mysqli_query($mysqli, "select sum(total_harga) as total from barang_laku where tanggal=".$tanggal);
	...
	$qu = mysqli_query($mysqli, "select sum(laba) as total_laba from barang_laku where tanggal=".$tanggal);
