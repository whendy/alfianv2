...
<head>
  ...
  <title>AdminLTE 3 | Komentar Blog/Artikel | <?php echo $nama;?></title>
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1> Komentar Blog/Artikel</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active"> Komentar Blog/Artikel</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
$result = mysqli_query($mysqli, "SELECT * FROM Komentar order by date desc ");
$no=1;
?>
		...
		while($res = mysqli_fetch_array($result)) {	
            ...
            ?>		
                ...
                <td class="center">
												&nbsp;<a href="koblog/<?php echo addslashes($res['id']);?>" title="Edit"><i class="fa fa-edit fa-fw"></i></a>&nbsp;
												&nbsp;<a href="hkoblog/<?php echo addslashes($res['id']);?>" title="Delete"><i class="fa fa-times fa-fw"></i></a>&nbsp;
												</td>
