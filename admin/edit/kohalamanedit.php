...
{	
	...
	if(empty($approved)) {
		...
		//updating the table
		$result = mysqli_query($mysqli, "UPDATE pages_komentar SET approved='$approved' WHERE id=$id");
		
		//redirectig to the display page. In our case, it is view.php
		echo "<script>window.alert('Data Berhasil DI Ubah')
        window.location='./../../admin/kohalaman'</script>";	
	}
}
?>
...
<head>
  ...
  <title>AdminLTE 3 | Edit Komentar Halaman | <?php echo $nama;?></title>
...
include_once("./../../config.php");
$id=$_GET['id'];
	$result=mysqli_query($mysqli, "SELECT * FROM pages_komentar WHERE id=$id");
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Komentar Halaman</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Edit Komentar Halaman</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="tab-content">
                  ...
                  <form action="../kohalaman/<?php echo addslashes($id);?>" method="POST" enctype='multipart/form-data'  class="form-horizontal">
