...
{	
	...
	if(empty($approved)) {
        ...
        window.location='./../../admin/koblog'</script>";	
	}
}
?>
...
<head>
  ...
  <title>AdminLTE 3 | Edit Komentar Blog/Artikel | <?php echo $nama;?></title>
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Komentar Blog/Artikel</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Edit Komentar Blog/Artikel</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="tab-content">
                  ...
                  <form action="../koblog/<?php echo addslashes($id);?>" method="POST" enctype='multipart/form-data'  class="form-horizontal">
